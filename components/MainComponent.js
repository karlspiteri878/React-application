...
class Main extends Component {
  componentDidMount(){
    ...
    NetInfo.addEventListener('connectionChange', this.handleConnecvitityChange)
  }

  componentWillUnmount(){
    NetInfo.removeEventListener('connectionChange', this.handleConnecvitityChange)
  }

  handleConnecvitityChange = (connectionInfo) => {
